...
class SubPages{  
  ...
  function subPageCss2(){  
   ...
   foreach($a as $key=>$value){
	...
	$subPageCss2Str.="[<span style='color:red;font-weight:bold;'>".$value."</span>]";  
	}
	else{  
    	 $url=$this->subPage_link.$value;  
         $subPageCss2Str.="[<a href='$url'>".$value."</a>]"; 
       }	
   }
...
//得到当前是第几页  
  ...
  $subPages=new SubPages($page_size,$nums,$pageCurrent,$sub_pages,basename(__FILE__).'?p=hubing',2);  
